...
class Arguments:
    ...
    save_dir: str = field(default="/storage/quach/snapshots/repg2/text_only")
    results_path: str = field(default="debug")

    workspace: str = field(default="varal7")
    project_name: str = field(default="rep-text-1")
...
def main():
    ...
    dataset = TextOnlyDataset.from_file(args.base, args.num_x, args.start_seed, args.end_seed, args.prefix, args.pretrained_bert)
    test_dataset = TextOnlyDataset.from_file(args.test_base, args.test_num_x, args.start_seed, args.end_seed, args.prefix, args.pretrained_bert)
